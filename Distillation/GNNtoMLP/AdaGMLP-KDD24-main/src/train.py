...
if __name__ == "__main__":
    ...
    print(results)
    filename = f'AdaGMLP.csv'
    print(f"Saving results to {filename}")
    with open(f"{filename}", 'a+') as write_obj:
        write_obj.write( "dataset:{},  lamb:{}, tau:{}, K:{}, testacc:{},STD:{} ".format(args.dataset,  args.lamb, args.tau, args.K, np.mean(test_best_list),np.std(test_best_list)))
        write_obj.write("\n")