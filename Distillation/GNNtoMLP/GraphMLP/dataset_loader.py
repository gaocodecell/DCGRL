...
class WebKB(InMemoryDataset):
    ...
    def __init__(self, root, name, transform=None, pre_transform=None):
        ...
        assert self.name in ['cornell', 'texas', 'film', 'wisconsin','chameleon', 'squirrel']#washington
...
def DataLoader(name):
    root_path = '../../'
    path = osp.join(root_path, 'datacon', name)
    ...
    # elif  name in [ 'film']:
    #     dataset = dataset_heterophily(path, name,T.NormalizeFeatures())
